...
module Class = struct
  ...
  let to_string = function
    ...
    | Warning                                -> "Warning"
    | No_data_this_is_also_a_warning_class_per_the_sql_standard -> "No Data (this is also a warning class per the SQL standard)"
    ...
    | Dependent_privilege_descriptors_still_exist -> "Dependent Privilege Descriptors Still Exist"
    ...
    | System_error_errors_external_to_postgresql_itself -> "System Error (errors external to PostgreSQL itself)"
